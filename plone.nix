...
let plone42Packages = python.modules // rec {
  ...
  plone = buildPythonPackage rec {
    ...
    propagatedBuildInputs = [ plone_app_caching plone_app_iterate plone_app_openid plone_app_theming products_cmfplacefulworkflow products_cmfplone products_kupu setuptools wicked zope_app_component zope_app_container zope_app_publisher zope_copypastemove ];
    meta = {
        maintainers = [ stdenv.lib.maintainers.goibhniu ];
    };
  };
  ...
  plone_app_caching = buildPythonPackage rec {
    ...
    propagatedBuildInputs = [ plone_app_z3cform plone_cachepurging plone_caching python_dateutil z3c_form z3c_zcmlhook zope_browserresource ];
    meta = {
        maintainers = [ stdenv.lib.maintainers.goibhniu ];
    };
  };
  ...
  plone_app_iterate = buildPythonPackage rec {
    ...
    propagatedBuildInputs = [ zope_viewlet ];
    meta = {
        maintainers = [ stdenv.lib.maintainers.goibhniu ];
    };
  };
  ...
  plone_fieldsets = buildPythonPackage rec {
    ...
    propagatedBuildInputs = [ five_formlib ];
    meta = {
        maintainers = [ stdenv.lib.maintainers.goibhniu ];
    };
  };
  ...
  products_archetypes = buildPythonPackage rec {
    ...
    propagatedBuildInputs = [ plone_folder products_marshall products_validation ];
    meta = {
        maintainers = [ stdenv.lib.maintainers.goibhniu ];
    };
  };
  ...
  products_cmfcore = buildPythonPackage rec {
    ...
    propagatedBuildInputs = [ products_zsqlmethods zope_app_publication ];
    meta = {
        maintainers = [ stdenv.lib.maintainers.goibhniu ];
    };
  };
  ...
  products_tinymce = buildPythonPackage rec {
    ...
    propagatedBuildInputs = [ elementtree zope_app_content ];
    meta = {
        maintainers = [ stdenv.lib.maintainers.goibhniu ];
    };
  };
  ...
  unidecode = buildPythonPackage rec {
    ...
    src = fetchurl {
      url = "http://pypi.python.org/packages/source/U/Unidecode/Unidecode-0.04.11.tar.gz";
  ...
  zope2 = buildPythonPackage rec {
    ...
    propagatedBuildInputs = [ accesscontrol documenttemplate docutils initgroups missing multimapping persistence products_btreefolder2 products_externalmethod products_mailhost products_mimetools products_ofsp products_pythonscripts products_standardcachemanagers products_zcatalog products_zctextindex pytz record restrictedpython tempstorage zconfig zdaemon zexceptions zlog zope_contentprovider zope_contenttype zope_processlifetime zope_proxy zope_sendmail zope_sequencesort zope_testbrowser zopeundo ];
    meta = {
        maintainers = [ stdenv.lib.maintainers.goibhniu ];
    };
  };
  ...
  zope_app_component = buildPythonPackage rec {
    ...
    propagatedBuildInputs = [ zope_app_pagetemplate zope_exceptions zope_formlib ];
    meta = {
        maintainers = [ stdenv.lib.maintainers.goibhniu ];
    };
  };
  ...
  zope_app_container = buildPythonPackage rec {
    ...
    propagatedBuildInputs = [ zope_browser zope_dublincore zope_size ];
    meta = {
        maintainers = [ stdenv.lib.maintainers.goibhniu ];
    };
  };
  ...
  zope_app_publisher = buildPythonPackage rec {
    ...
    propagatedBuildInputs = [ zope_browsermenu zope_browserpage zope_componentvocabulary zope_configuration zope_datetime zope_ptresource zope_security ];
    meta = {
        maintainers = [ stdenv.lib.maintainers.goibhniu ];
    };
  };
  ...
  zope_copypastemove = buildPythonPackage rec {
    ...
    propagatedBuildInputs = [ zope_annotation zope_copy zope_lifecycleevent ];
    meta = {
        maintainers = [ stdenv.lib.maintainers.goibhniu ];
    };
  };
