...
#
# COMMAND:
#   pypi2nix -e jinja2 -e requests -e click -V 3 --default-overrides
#
...
let
  ...
  commonOverrides = [
    (let src = pkgs.fetchgit { url = "https://github.com/garbas/nixpkgs-python.git"; sha256 = "0fs166kfzy8bn532p6qy7q34xfl0im2iqipvy3532zsc8aykyqk4"; rev = "41b619712947531f68006467700b38f11780e517"; } ; in import "${src}/overrides.nix" { inherit pkgs python; })
  ];
  allOverrides =
